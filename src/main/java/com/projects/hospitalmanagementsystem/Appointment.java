...
public class Appointment {
    ...
    public Appointment(Integer id, Integer appointmentID, String name, String gender,
    ...
    public Appointment(Integer appointmentID, String name, String gender,
                       Long mobileNumber, String description, String diagnosis, String treatment, String address,
                       Date date, Date dateModify, Date dateDelete, String status, Date schedule) {
    ...
    public Appointment(Integer appointmentID, String name,
    ...
    public Appointment(Integer appointmentID, String description,
