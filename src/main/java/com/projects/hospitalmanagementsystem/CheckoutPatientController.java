...
import com.projects.hospitalmanagementsystem.Data;
import com.projects.hospitalmanagementsystem.Doctor;
import java.net.URL;
...
public class CheckoutPatientController implements Initializable {
        ...
        if (checkout_checkout.getValue() == null
            ...
            if (alert.confirmationMessage("Are you sure you want to pay?")) {
                ...
                try {
                    ...
                    String updateData = "UPDATE patient SET status_pay = ?, date_delete = ? WHERE patient_id = ?";

                    prepare = connect.prepareStatement(updateData);
                    prepare.setString(1, "Paid");
                    prepare.setString(2, String.valueOf(sqlDate));
                    prepare.setString(3, checkout_patientID.getText());
                    prepare.executeUpdate();
    ...
    public void displayFields()
    {
        ...
        checkout_doctor.setText(Data.temp_doctorName);
