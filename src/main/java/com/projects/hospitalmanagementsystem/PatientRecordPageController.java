 ...
 * @author WINDOWS 10
 */
public class PatientRecordPageController implements Initializable {
    ...
    @FXML
    private TableColumn<Patient, String> recordpage_col_patientID;
    ...
    @FXML
    private TableColumn<Patient, String> recordpage_col_mobileNumber;

    @FXML
    private TableColumn<Patient, String> recordpage_col_address;

    @FXML
    private TableColumn<Patient, String> recordpage_col_dateCreated;

    @FXML
    private TableColumn<Patient, String> recordpage_col_dateModiftied;

    @FXML
    private TableColumn<Patient, String> recordpage_col_dateDeleted;
    ...
    public ObservableList<Patient> getPatientRecordData() {
    ...
    private ObservableList<Patient> patientRecordData;
                    ...
                    if (empty) {
                        ...
                        editButton.setOnAction((ActionEvent event) -> {
                            try {
                                ...
                                Patient pData = recordpage_tableView.getSelectionModel().getSelectedItem();
